 ...
 * Toast Component
 *
 * Simple toast notification using Tailwind CSS only.
...
export default function Toast({
  ...
  return (
    <div
      ...
      aria-atomic="true"
    >
      <div className={`flex items-start gap-3 p-4 rounded-lg border-l-4 shadow-lg ${variant.bg}`}>
...
// CSS for animation (add to globals.css if not present)
