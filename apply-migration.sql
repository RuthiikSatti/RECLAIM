-- ============================================================================
-- APPLY THIS MIGRATION TO FIX: "Could not find the table 'public.conversations'"
-- ============================================================================
--
-- Instructions:
...
-- 8. Enable realtime for 'conversations' table
-- 9. Refresh your app
--
...
BEGIN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies
    WHERE tablename = 'conversations'
    AND policyname = 'System can insert conversations'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies
    WHERE tablename = 'conversations'
    AND policyname = 'System can update conversations'
  ) THEN
...
-- ============================================================================
-- 7. BACKFILL EXISTING DATA (OPTIONAL - RUN ONCE)
-- ============================================================================
...
BEGIN
  ...
  RAISE NOTICE '2. Enable realtime for "conversations" table';
  RAISE NOTICE '3. Refresh your application';
