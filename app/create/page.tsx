  ...
  return (
    <div className="min-h-screen bg-[#f5f5f0] py-16 px-4">
      <div className="max-w-2xl mx-auto">
        {/* Header - Using maintanker-title utility class */}
        <h1 className="maintanker-title tracking-maintanker text-4xl sm:text-5xl md:text-6xl lg:text-7xl mb-12 text-black">
          CREATE LISTING
        </h1>
